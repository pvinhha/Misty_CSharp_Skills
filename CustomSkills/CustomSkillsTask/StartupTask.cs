using SkillLibrary;	// Enable app to use skill code
using MistyRobotics.Common.Types;	// Enable app to use robot data types
using MistyRobotics.SDK.Messengers;	// Enable connection to robot
using Windows.ApplicationModel.Background;	// Enable app to schedule background tasks
...
namespace IntroSkillsTask
{
	...
	{
		/*
		 * Current custom skills in (somewhat) order of complexity:
